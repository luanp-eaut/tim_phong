...
2.  **Chuyển đổi định dạng:** Mở file .csv và lưu lại (Save As) sang định dạng **.xlsx**. Đặt tên file là `lich_hoc.xlsx`. <mark>(Mở trực tiếp từ excel thì hơi phức tạp, phải dùng Get Data, tốt nhất là upload lên google drive, mở bằng google sheet rồi tải về dạng .xslx)</mark>.
3.  **Làm sạch dữ liệu:**
